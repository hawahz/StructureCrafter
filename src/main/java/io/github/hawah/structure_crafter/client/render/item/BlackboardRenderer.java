...
public class BlackboardRenderer implements SpecialModelRenderer<BlackboardRenderer> {
    ...
    @Override
    public void submit(@Nullable BlackboardRenderer argument, ItemDisplayContext displayContext, PoseStack poseStack, SubmitNodeCollector nodeCollector, int light, int overlay, boolean hasFoil, int outlineColor) {
//        poseStack.pushPose();
//
...
//            renderBlackboardLeftArm(displayContext, poseStack, bufferSource, light, overlay);
//        } else {
